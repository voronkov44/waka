    ...
    <div className="min-h-screen pb-32">
      <div className="sticky top-0 z-40 border-b border-border/40 bg-background/80 pt-safe backdrop-blur-[32px]">
        <div className="flex items-center justify-between px-6 py-4">
          ...
          <div className="text-sm font-bold uppercase tracking-[0.2em] text-foreground">{t('common.legal')}</div>
      ...
      <div className="px-6 pt-8">
        <div className="rounded-[32px] border border-border/50 bg-card p-8 shadow-sm">
          <h1 className="mb-4 text-3xl font-extrabold tracking-tighter text-foreground">{t('legal.privacyTitle')}</h1>
          ...
          <div className="rounded-2xl border border-border/50 bg-background p-5">
            <p className="text-[11px] font-bold uppercase tracking-[0.14em] text-muted-foreground">{t('common.contentComingSoon')}</p>
          </div>
        </div>
      </div>
    </div>
