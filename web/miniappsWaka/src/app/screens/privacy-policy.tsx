    ...
    <div className="min-h-screen pb-32">
      ...
      <div className="px-6 pt-8">
        <div className="rounded-[32px] border border-border/50 bg-card p-8 shadow-sm">
          <h1 className="mb-4 text-3xl font-extrabold tracking-tighter text-foreground">Privacy Policy</h1>
          <p className="mb-6 text-sm font-medium leading-relaxed text-muted-foreground">
            This section will describe how profile and usage data is handled in the Waka mini app.
          </p>
