...
const presetClassMap: Record<ModelImagePreset, string> = {
  ...
  featured:
    'h-full w-full object-contain object-center scale-[1.56] translate-y-[8%] filter drop-shadow-2xl transition-transform duration-700 ease-[cubic-bezier(0.2,0.8,0.2,1)] group-hover:scale-[1.66]',
  catalog:
    'h-full w-full object-contain object-center scale-[1.38] translate-y-[2%] filter drop-shadow-2xl transition-transform duration-700 ease-[cubic-bezier(0.2,0.8,0.2,1)] group-hover:scale-[1.46]',
  related:
    'h-full w-full object-contain object-center scale-[1.56] translate-y-[8%] filter drop-shadow-xl transition-transform duration-700 ease-[cubic-bezier(0.2,0.8,0.2,1)] group-hover:scale-[1.66]',
  details:
